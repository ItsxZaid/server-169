...
export const data = new SlashCommandBuilder()
  ...
  .setDescription("Displays the buff schedule and allows booking.")
...
export async function execute(
  ...
  try {
    ...
    console.error("Error executing /buff-calendar:", error);
    await interaction.editReply(
      "An error occurred while fetching the buff calendar.",
    );
  }
}
