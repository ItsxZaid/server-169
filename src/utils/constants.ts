...
export const PENDING_APPLICANT_ROLE = { name: 'Candidate', color: '#808080' as ColorResolvable };

export const RANK_ROLES: { name: string, color: ColorResolvable }[] = [
    { name: 'R1', color: '#1abc9c' }, { name: 'R2', color: '#2ecc71' },
    { name: 'R3', color: '#3498db' }, { name: 'R4', color: '#9b59b6' },
